        ...
        <main>
            <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-auto mb-3 mb-md-0 me-auto">
                            <div class="w-auto sw-md-70">
                                ...
                                <h1 class="mb-0 pb-0 display-4" id="title">Данные о центре №<?php echo $_GET['id']; ?></h1>
                            </div>
                        </div>
                        <!-- Title End -->
                    </div>
                ...
                <div class="row gx-4 gy-5">
                    <!-- Customer Start -->
                    <?php
                    $sqlItem = "select * from `center` where ctid=" . $centerId;
                            ...
                            <div class="card-body mb-n5">
                                <div class="d-flex align-items-center flex-column">
                                    <div class="mb-5 d-flex align-items-center flex-column">
                                        <div class="h5 mb-1"><?php echo $dataItem['ctname']; ?></div>
                                    </div>
                                </div>
                                <div class="d-flex justify-content-center">
                                    <div class="d-flex flex-row justify-content-between w-100 w-sm-50 w-xl-100 mb-5">
                                        <a href="./addcenter.php?editId=<?php echo $_GET['id']; ?>" class="btn btn-primary w-100 me-2">Редактировать</a>
                                    </div>
                                </div>
                                <div class="mb-5">
                                    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                        <div class="carousel-inner" style="margin-left: auto; margin-right: auto;">
                                            <?php
                                            $sqlImage = "select * from `centerimage` where ctid=" . $centerId;
                                            ...
                                            ?>
                                                    <div class="carousel-item active">
                                                        <img class="d-block w-300 h-100" src="./uploads/<?php echo $dataImage['imgname']; ?>" alt="image">
                                                    </div>
                                                <?php } else { ?>
                    ...
                    <div class="col-12 col-xl-8 col-xxl-6">
                        ...
                        <div class="d-flex justify-content-between">
                            <h2 class="small-title">Характеристики</h2>
                        </div>
                        <div class="mb-1">
                            <div class="card mb-2">
                                        ...
                                        <div class="card-body pt-0 pb-0 h-100">
                                            <div class="row g-0 h-100 align-content-center">
                                                ...
                                                <div class="col-6 col-md-9 d-flex flex-column justify-content-center mb-2 mb-md-0">
                                                    ...
                                                    <div class="text-alternate"><?php echo $dataItem['ctid'] ?></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col">
                                        <div class="card-body pt-0 pb-0 h-100">
                                            <div class="row g-0 h-100 align-content-center">
                                                <div class="col-6 col-md-3 d-flex flex-column justify-content-center mb-2 mb-md-0 h-md-100">
                                                    <div class="text-muted text-small d-md-none">ID</div>
                                                    <div class="text-alternate">Название</div>
                                                </div>
                                                <div class="col-6 col-md-9 d-flex flex-column justify-content-center mb-2 mb-md-0">
                                                    <div class="text-muted text-small d-md-none">Price</div>
                                                    <div class="text-alternate"><?php echo $dataItem['ctname'] ?></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col">
                                        <div class="card-body pt-0 pb-0 h-100">
                                            <div class="row g-0 h-100 align-content-center">
                                                <div class="col-6 col-md-3 d-flex flex-column justify-content-center mb-2 mb-md-0 h-md-100">
                                                    <div class="text-muted text-small d-md-none">ID</div>
                                                    <div class="text-alternate">Город</div>
                                                </div>
                                                <div class="col-6 col-md-9 d-flex flex-column justify-content-center mb-2 mb-md-0">
                                                    <div class="text-muted text-small d-md-none">Price</div>
                                                    <div class="text-alternate">
                                                        <?php
                                                        $sqlCategory = "select cname from `city` where cid=" . $dataItem['cid'];
                                    ...
                                    <div class="col">
                                        <div class="card-body pt-0 pb-0 h-100">
                                            <div class="row g-0 h-100 align-content-center">
                                                <div class="col-6 col-md-3 d-flex flex-column justify-content-center mb-2 mb-md-0 h-md-100">
                                                    <div class="text-muted text-small d-md-none">ID</div>
                                                    <div class="text-alternate">Адрес</div>
                                                </div>
                                                <div class="col-6 col-md-9 d-flex flex-column justify-content-center mb-2 mb-md-0">
                                                    <div class="text-muted text-small d-md-none">Price</div>
                                                    <div class="text-alternate"><?php echo $dataItem['ctaddress'] ?></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col">
                                        <div class="card-body pt-0 pb-0 h-100">
                                            <div class="row g-0 h-100 align-content-center">
                                                <div class="col-6 col-md-3 d-flex flex-column justify-content-center mb-2 mb-md-0 h-md-100">
                                                    <div class="text-muted text-small d-md-none">ID</div>
                                                    <div class="text-alternate">Статус</div>
                                                </div>
                                                <div class="col-6 col-md-9 d-flex flex-column justify-content-center mb-2 mb-md-0">
                                                    <div class="text-muted text-small d-md-none">Price</div>
                                                    <div class="text-alternate"><?php echo $dataItem['ctstatus'] ?></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col">
                                        <div class="card-body pt-0 pb-0 h-100">
                                            <div class="row g-0 h-100 align-content-center">
                                                <div class="col-6 col-md-3 d-flex flex-column justify-content-center mb-2 mb-md-0 h-md-100">
                                                    <div class="text-muted text-small d-md-none">ID</div>
                                                    <div class="text-alternate">Количество кортов</div>
                                                </div>
                                                <div class="col-6 col-md-9 d-flex flex-column justify-content-center mb-2 mb-md-0">
                                                    <div class="text-muted text-small d-md-none">Price</div>
                                                    <div class="text-alternate">
                                                    <?php
                                                    $sqlCountCity = "select count(*) c from `court` where ctid=" . $dataItem['ctid'];
                                                    $resCountCity = $conn -> query($sqlCountCity);
                                                    $dataCountCity = mysqli_fetch_assoc($resCountCity);
                                                    echo $dataCountCity['c'];
                                                    ?>
                                                    </div>
                                                </div>
                                            </div>
