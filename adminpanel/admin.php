                    ...
                    <div class="row">
                        <div class="col-auto mb-3 mb-md-0 me-auto">
                            <div class="w-auto sw-md-50">
                                ...
                                <h1 class="mb-0 pb-0 display-4" id="title">Список администраторов</h1>
                            </div>
                        </div>

                        <div class="col-3 d-flex align-items-end justify-content-end">
                            <div class="btn-group ms-1 check-all-container">
                                <button type="button" class="export btn btn-outline-primary p-2 pb-1 ps-0 pe-4" name="export-admin">Export to Excel</button>
                                <a href="./addadmin.php" class="btn btn-outline-primary p-2 pb-1 ps-0 pe-4">
                ...
                <div class="row">
                    <div class="col-12 mb-5">
                        <div class="card mb-2 bg-transparent no-shadow d-none d-md-block">
                            <div class="card-body pt-0 pb-0 sh-3">
                                <div class="row g-0 h-100 align-content-center">
                                    <div class="col-12 col-md-3 d-flex align-items-center mb-2 mb-md-0 text-muted text-small">ID</div>
                                    <div class="col-6 col-md-3 d-flex align-items-center text-alternate text-medium text-muted text-small">НАЗВАНИЕ</div>
                                    <div class="col-6 col-md-4 d-flex align-items-center text-alternate text-medium text-muted text-small">РОЛЬ</div>
                                    <div class="col-6 col-md-1 d-flex align-items-center text-alternate text-medium text-muted text-small">УДАЛИТЬ</div>
                                </div>
                            </div>
                        </div>
                        <?php
                        $sql = "select * from `admin` where arole != 2;";
                        $res = $conn->query($sql);
                        if ($res->num_rows > 0) {
                                ...
                                <div id="checkboxTable">
                                    <div class="card mb-2">
                                        <div class="card-body pt-0 pb-0 sh-21 sh-md-8">
                                            <div class="row g-0 h-100 align-content-center">
                                                <div class="col-12 col-md-3 d-flex flex-column justify-content-center mb-2 mb-md-0 order-1 order-md-1 h-md-100 position-relative">
                                                    <div class="text-muted text-small d-md-none">ID</div>
                                                    <div class="text-alternate"><?php echo $data['aid']; ?></div>
                                                </div>
                                                <div class="col-6 col-md-3 d-flex flex-column justify-content-center mb-2 mb-md-0 order-3 order-md-2">
                                                    ...
                                                    <div class="text-alternate"><?php echo $data['username']; ?></div>
                                                </div>
                                                <div class="col-6 col-md-4 d-flex flex-column justify-content-center mb-2 mb-md-0 order-3 order-md-2">
                                                    <div class="text-muted text-small d-md-none">РОЛЬ</div>
                                                    <div class="text-alternate">
                                                    <?php
                                                    if ($data['arole'] == 0) echo 'Администратор';
                                                    elseif ($data['arole'] == 1) echo 'Аудит';
                                                    else echo 'Менеджер центра';
                                                    ?>
                                                    </div>
                                                </div>
                                                <div class="col-6 col-md-1 d-flex flex-column justify-content-center mb-2 mb-md-0 order-3 order-md-2">
                                                    ...
                                                    <div class="text-alternate">
                                                        <a class="delete" name="delete-admin" id="<?php echo $data['aid']; ?>" href="javascript:void(0)">
                        ...
                        <?php }
                            ...
                            echo "Нет данных о существующих администраторах";
                        } ?>
                    </div>
                </div>
            </div>
