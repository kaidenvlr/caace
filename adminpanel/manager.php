                    ...
                    <div class="row">
                        <div class="col-auto mb-3 mb-md-0 me-auto">
                            <div class="w-auto sw-md-50">
                                ...
                                <h1 class="mb-0 pb-0 display-4" id="title">Список менеджеров</h1>
                            </div>
                        </div>
                        ...
                        <div class="col-3 d-flex align-items-end justify-content-end">
                            <div class="btn-group ms-1 check-all-container">
                                ...
                                <a href="./addmanager.php" class="btn btn-outline-primary p-2 pb-1 ps-0 pe-4">
                ...
                <div class="row">
                    <div class="col-12 mb-5">
                                        ...
                                        <div class="card-body pt-0 pb-0 sh-21 sh-md-8">
                                            <div class="row g-0 h-100 align-content-center">
                                                ...
                                                <div class="col-6 col-md-4 d-flex flex-column justify-content-center mb-2 mb-md-0 order-3 order-md-2">
                                                    ...
                                                    <?php
                                                    $sqlCenter = "select ctname from `center` where ctid = (select ctid from `centerrole` where aid = " . $data['aid'] . ")";
                                                ...
                                                <div class="col-6 col-md-1 d-flex flex-column justify-content-center mb-2 mb-md-0 order-3 order-md-2">
                                                    ...
                                                    <div class="text-alternate">
                                                        <a class="delete" name="delete-manager" id="<?php echo $data['aid']; ?>" href="javascript:void(0)">
                        ...
                        <?php }
                            ...
                            echo "Нет данных о существующих менеджерах";
                        } ?>
                    </div>
                </div>
            </div>
