                    ...
                    <div class="row">
                        <div class="col-auto mb-3 mb-md-0 me-auto">
                            <div class="w-auto sw-md-50">
                                ...
                                <h1 class="mb-0 pb-0 display-4" id="title">Список тарифов</h1>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-12 mb-5">
                        <div class="card mb-2 bg-transparent no-shadow d-none d-md-block">
                            <div class="card-body pt-0 pb-0 sh-3">
                                <div class="row g-0 h-100 align-content-center">
                                    ...
                                    <div class="col-6 col-md-3 d-flex align-items-center text-alternate text-medium text-muted text-small">КОРТ</div>
                                    <div class="col-6 col-md-1 d-flex align-items-center text-alternate text-medium text-muted text-small">ВРЕМЯ НАЧАЛА</div>
                                    <div class="col-6 col-md-1 d-flex align-items-center text-alternate text-medium text-muted text-small">ВРЕМЯ КОНЦА</div>
                                    <div class="col-6 col-md-1 d-flex align-items-center text-alternate text-medium text-muted text-small">ПРАЙС</div>
                                    ...
                                    <div class="card mb-2">
                                        <div class="card-body pt-0 pb-0 sh-21 sh-md-8">
                                            <div class="row g-0 h-100 align-content-center">
                                                ...
                                                <div class="col-6 col-md-3 d-flex flex-column justify-content-center mb-2 mb-md-0 order-3 order-md-2">
                                                    <div class="text-muted text-small d-md-none">КОРТ</div>
                                                    <div class="text-alternate"><?php 
                                                ...
                                                <div class="col-6 col-md-1 d-flex flex-column justify-content-center mb-2 mb-md-0 order-3 order-md-2">
                                                    <div class="text-muted text-small d-md-none">ВРЕМЯ НАЧАЛА</div>
                                                    <div class="text-alternate"><?php 
                                                ...
                                                <div class="col-6 col-md-1 d-flex flex-column justify-content-center mb-2 mb-md-0 order-3 order-md-2">
                                                    <div class="text-muted text-small d-md-none">ВРЕМЯ КОНЦА</div>
                                                    <div class="text-alternate"><?php 
                                                ...
                                                <div class="col-6 col-md-1 d-flex flex-column justify-content-center mb-2 mb-md-0 order-3 order-md-2">
                                                    <div class="text-muted text-small d-md-none">ПРАЙС</div>
                        ...
                        <?php }
                            ...
                            echo "Нет данных о существующих тарифах";
                        } ?>
                    </div>
                </div>
            </div>
